...
def combination1():
    ...
    plt.subplots_adjust(hspace=0.35, wspace=0.2, left=0.19) # for legend
    ...
    handles, labels = ax[0, 0].get_legend_handles_labels()
    fig.legend(handles, labels, loc='center left', fontsize=21)

    # plt.show()
    plt.savefig('combination-1-poster.pdf', bbox_inches='tight', dpi=500)
