...
rm -rf data env_temp_cfg cbp_temp_cfg bp_temp_cfg snp_temp_cfg l2_temp_cfg utils_saved 
mkdir -p env_temp_cfg cbp_temp_cfg bp_temp_cfg snp_temp_cfg l2_temp_cfg
...
for config_file in "cfg/sgd/cbp/relu.json" "cfg/sgd/bp/relu.json" "cfg/sgd/shrink-and-perturb/snp.json" "cfg/sgd/l2/l2.json"; do
