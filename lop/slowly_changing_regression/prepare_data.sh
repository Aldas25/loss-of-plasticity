...
rm -rf data env_temp_cfg cbp_temp_cfg bp_temp_cfg snp_temp_cfg l2_temp_cfg cbp_snp_temp_cfg utils_saved cbp_l2_temp_cfg
mkdir -p env_temp_cfg cbp_temp_cfg bp_temp_cfg snp_temp_cfg l2_temp_cfg cbp_snp_temp_cfg cbp_l2_temp_cfg
...
for config_file in "cfg/sgd/shrink-and-perturb/cbp_snp.json" "cfg/sgd/cbp/cbp_with_l2.json"; do
