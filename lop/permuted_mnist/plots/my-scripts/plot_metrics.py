...
def main(arguments):
    ...
    parent_dir = '/home/aldas/TUDelft/RP/results_copied/05-29_permuted-mnist-5runs'
    ...
    cbp_l2_cfg, cbp_l2_setting_idx = parent_dir + '/cfg/cbp_l2.json', 1
    cbp_snp_cfg, cbp_snp_setting_idx = parent_dir + '/cfg/cbp_snp.json', 8
    ...
    print(f'CBP+SnP list_params: {list_params}, setting: {param_settings[cbp_snp_setting_idx]}')
    quit(0)

    # selected_ids = [8,11,12,13,14]
    ...
    generate_online_performance_plot(
        ...
        xticks=[0, 100*m, 200*m],
        xticks_labels=['200', '300', '400'],
        m=m,
        fontsize=16,
        labels=labels,
        filename_pref='all_no-bp_accuracy_last'
