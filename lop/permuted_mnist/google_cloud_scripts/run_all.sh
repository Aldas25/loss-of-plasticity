...
taskset -c 1 ./run_experiments_in_cfg_dir.sh $cfg_dir 8 14 >> "$LOG_FILE_BASE-1.log" 2>&1 &
taskset -c 2 ./run_experiments_in_cfg_dir.sh $cfg_dir 15 21 >> "$LOG_FILE_BASE-2.log" 2>&1 &
taskset -c 3 ./run_experiments_in_cfg_dir.sh $cfg_dir 22 29 >> "$LOG_FILE_BASE-3.log" 2>&1 &
